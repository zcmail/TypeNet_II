...
Dropout(abs_of_sub, 0.4)
Dens_layer1 = Dense(128, activation= 'relu', input_dim= 128, use_bias= True)(abs_of_sub)
Dropout(Dens_layer1, 0.4)
Dens_layer2 = Dense(32, activation= 'relu', input_dim= 128, use_bias= True)(Dens_layer1)
Dropout(Dens_layer2, 0.4)
Dens_layer3 = Dense(1, activation= 'sigmoid', input_dim= 32, use_bias= True)(Dens_layer2)


#model = Model([input_left, input_right], distance)
model = Model([input_left, input_right], Dens_layer3)
...
model_path = "./Dense128_2LSTM_distance_step20_epochs_"+str(epochs)+"batch_size_"+str(batch_size)+"_lr001_same<0.5.h5"
